...
#         return_sequences=True, implementation=2, name='rnn')(bn_cnn)
    rnn = GRU(units, activation='relu', return_sequences=True, name='rnn')(bn_cnn)
    # TODO: Add batch normalization
...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    rnn_1 = GRU(units, activation='relu', return_sequences=True, name='rnn_1')(input_data)
    bn_rnn_1 = BatchNormalization(name='bn_gru_1')(rnn_1)
    rnn_2 = GRU(units, activation='relu', return_sequences=True, name='rnn_2')(bn_rnn_1)
    bn_rnn_2 = BatchNormalization(name='bn_gru_2')(rnn_2)
    # TODO: Add a TimeDistributed(Dense(output_dim)) layer
